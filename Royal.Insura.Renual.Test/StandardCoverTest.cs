...
{
    public class StandardCoverTest
    {
        ...
        public void Initial_Amount_Positive_calculation()
        {
            ...
            var defaultCalculator = new StandardCover(productTypeInfo.Object,configuration.Object, mockReviser.Object);
        ...
        public void Title_Value_Check()
        {
            ...
            var defaultCalculator = new SpecialCover(mockReviser.Object, configuration.Object, productTypeInfo.Object);
            var result = defaultCalculator.PremiumCalculationAmount(inputDto);

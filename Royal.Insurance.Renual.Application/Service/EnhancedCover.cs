...
{
    public class EnhancedCover : IPremiumCalculation
    {
        private readonly IConfiguration _configuration;
        private readonly ICommonProductType _commonProductType;
        private readonly IProductTypeInfo _productTypeInfo;
        public EnhancedCover(ICommonProductType commonProductType, IConfiguration configuration, IProductTypeInfo productTypeInfo)
        {
